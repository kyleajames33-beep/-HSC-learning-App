...
const ErrorFallback = ({ error, errorInfo, resetErrorBoundary, onRetry }) => {
  const handleRetry = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-gray-600 mb-6">
          We&apos;re sorry for the disruption. Please try again, and if the issue continues reload the app.
        </p>
